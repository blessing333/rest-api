...
class OrderServiceImplTest {
    ...
    @DisplayName("존재하지 않는 아이템에 대해 주문을 시도하면 OrderCreateFailException을 발생시킨다.")
    @Test
    void createOrderWithInvalidItem() {
        ...
        Assertions.assertThrows(OrderCreateFailException.class,()->orderService.createOrder(orderCommand));
    }
